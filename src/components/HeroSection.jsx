    ...
    <section id="hero" style={{
      ...
      <div className="container relative z-10 w-full flex justify-center px-2 md:px-4">
        ...
        >
          ...
          {/* Main Title */}
          <motion.h1 variants={itemVariants} className="font-black tracking-tight mb-8 md:mb-10 font-space text-slate-900 dark:text-white uppercase flex flex-col items-center gap-2 md:gap-4">
            ...
            <span className="text-[clamp(0.75rem,1.5vw,1rem)] text-slate-500 dark:text-slate-400 font-bold tracking-[0.2em] mt-4">DENGAN BANTUAN AI</span>
          </motion.h1>

          {/* Target Location */}
          <motion.p variants={itemVariants} className="text-[clamp(1rem,2vw,1.25rem)] font-bold text-cyan-700 dark:text-cyan-400 mb-10 tracking-wider uppercase">
            Di SMKS Rajasa Surabaya
          </motion.p>

          {/* Footer Info / Tagline */}
          <motion.div variants={itemVariants} className="flex items-center justify-center gap-3 flex-wrap text-[0.85rem] text-slate-700 dark:text-slate-400 mb-12 font-mono tracking-wider font-semibold uppercase">
